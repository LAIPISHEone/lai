<template>
  <div class="home">
    <div class="search-bar">
      ...
      <el-button type="primary" @click="getCoursesData">查询</el-button>
    ...
    <div class="subject-cards">
      <el-row :gutter="20">
        ...
        <template v-else-if="searchText">
          <el-col :span="24">
            <el-empty description="没有找到相关课程" :image-size="200">
  ...
  methods: {
    ...
    saveCard() {
      this.$refs.cardForm.validate((valid) => {
        if (valid) {
          const newCard = {
            course_name: this.cardForm.title,
            description: this.cardForm.description,
            type: this.cardForm.type,
            tag_type: this.cardForm.tagType,
            // tags: [...this.cardForm.tags],
          };

          if (this.editingIndex > -1) {
            // 编辑现有卡片
            updateCourses(newCard).then((res) => {
              if (res.code === 200) {
